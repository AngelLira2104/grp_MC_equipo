...
<#if listAsignaciones?has_content>
  <form name="detalleGeneralForm" method="post" action="">
    <div class="table-responsive mb-4">
      <h3 class="text-center text-lg font-bold mb-2">Asignaciones</h3>

      <table class="table table-striped table-bordered w-full text-sm text-left">
            ...
            <tr class="${tableRowClass(row_index)}">
              ...
              <td class="text-center">
                <button type="button"
                        ...
                        onclick="Elimina('${count}')">
                  ${uiLabelMap.ElimiarPermiso}
                </button>
              </td>
            </tr>
...
<!--Tabla de asignaciones anteriores
<#if listAsignaciones?has_content>
<form name="detalleGeneralForm" method="post" action="">
  <table width=100%>
