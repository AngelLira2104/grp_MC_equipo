...
<tr>
  <td style="vertical-align: top; width: 35%;">
	...
	<@displayReportGroup group="CONAC_CONTABLES" nameOnly=true>
		<li><a href="http://40.0.0.71:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3ACONAC%3AContables%3AEF1-Estado_situacion_financiera.prpt/viewer" target="_blank">${uiLabelMap.EF1}</a></li>
		<li><a href="http://40.0.0.71:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3ACONAC%3AContables%3AEF2-Estado_analitico_del_activo.prpt/viewer" target="_blank">${uiLabelMap.EF2}</a></li>
		<li><a href="http://40.0.0.71:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3ACONAC%3AContables%3AEF3-Estado_de_actividades.prpt/viewer" target="_blank">${uiLabelMap.EF3}</a></li>
		<li><a href="http://40.0.0.71:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3ACONAC%3AContables%3AEF4-Estado_de_cambios_en_la_situacion_financiera.prpt/viewer" target="_blank">${uiLabelMap.AccountingEF4}</a></li>	
		<li><a href="http://40.0.0.71:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3ACONAC%3AContables%3AEF5%20Estado%20de%20Variaci%C3%B3n%20en%20la%20Hacienda%20Publica.prpt/viewer" target="_blank">${uiLabelMap.EF5Conac}</a></li>
		...
		<li><a href="http://40.0.0.71:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3ACONAC%3AContables%3AEF7%20Estado%20Anal%C3%ADtico%20de%20la%20Deuda%20y%20Otros%20Pasivos.prpt/viewer" target="_blank">${uiLabelMap.EF7}</a></li>
	</@displayReportGroup>		
    <@displayReportGroup group="CONAC_PRESUPUESTALES" nameOnly=true>
		...
		<li><a href="http://40.0.0.71:8080/pentaho/api/repos/%3Ahome%3AFINABIEN%3ACONAC%3APresupuestales%3AEstado_analitico_del_ejercicio_del_presupuesto_de_egresos_clasificacion_administrativa.prpt/viewer" target="_blank">${uiLabelMap.AccountingEAEPXCA}</a></li>
